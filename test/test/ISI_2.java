...
public class ISI_2 extends ISI_Base_2 {
	...
	public void radiatedMethod() {
		String stringVar_1 = stringMethod_3(1, 2).concat("lalala").intern(); //mutGenLimit 1
		Comparator<String> stringVar_2 = stringMethod_4(1, 2).CASE_INSENSITIVE_ORDER; //mutGenLimit 1
