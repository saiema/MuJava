 ...
 *		) ;
 */
public class SinglyLinkedListBinaryExpressionFieldVarSwitch {
	...
	public static void main(String[] args) {
		SinglyLinkedListBinaryExpressionFieldVarSwitch list = new SinglyLinkedListBinaryExpressionFieldVarSwitch();
