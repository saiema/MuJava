 ...
 *		) ;
 */
public class SinglyLinkedListBinaryExpressionVarFieldWhile {
	...
	public static void main(String[] args) {
		SinglyLinkedListBinaryExpressionVarFieldWhile list = new SinglyLinkedListBinaryExpressionVarFieldWhile();
