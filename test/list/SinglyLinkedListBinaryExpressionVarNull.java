 ...
 *		) ;
 */
public class SinglyLinkedListBinaryExpressionVarNull {
	...
	public static void main(String[] args) {
		SinglyLinkedListBinaryExpressionVarNull list = new SinglyLinkedListBinaryExpressionVarNull();
