 ...
 *		) ;
 */
public class SinglyLinkedListOutsideMUC {
	...
	SinglyLinkedListNode, next).has(n); n.value==value_param)
	   ...
	   public boolean contains( /*@nullable@*/ Object value_param )
	   {
	       ...
	       boolean result;
	       int intV = 0;
	       current.next = header; 	//mutGenLimit 1
	       current.value = intV++;	//mutGenLimit 1
	       Object test = current;	//mutGenLimit 1
	       result = false;
	...
	public static void main(String[] args) {
		SinglyLinkedListOutsideMUC list = new SinglyLinkedListOutsideMUC();
