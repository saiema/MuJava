...
public class JTI_DUMBTests {
	
	private Property prop;
	private List<MutantInfo> mutantsInfo;
	
	public JTI_DUMBTests(Property prop, List<MutantInfo> mutantsInfo) {
		this.prop = prop;
	...
	public static Collection<Object[]> firstValues() {
		...
		mcJTI_DUMB_1.add(Pattern.compile("field1 = this\\.field4; //mutGenLimit 0"));
		...
		mcJTI_DUMB_2.add(Pattern.compile("radiatedMethod\\( field1 \\+ field2, field3 \\+ this\\.field4 \\); //mutGenLimit 1"));
		...
		mcJTI_DUMB_2.add(Pattern.compile("int var1 = field1 \\+ radiatedMethod\\( field2 \\+ radiatedMethod\\( field3, this\\.field4 \\), radiatedMethod\\( field5, field6 \\) \\); //mutGenLimit 2"));
		...
		mcJTI_DUMB_2.add(Pattern.compile("return var1 \\+ radiatedMethod\\( var1 \\+ field2 \\+ this\\.field4, field3 \\); //mutGenLimit 99"));
