...
public class ISD_DUMBTests {
	
	private Property prop;
	private List<MutantInfo> mutantsInfo;
	
	public ISD_DUMBTests(Property prop, List<MutantInfo> mutantsInfo) {
		this.prop = prop;
	...
	public static Collection<Object[]> firstValues() {
		...
		Property propISD_1 = new Property(MutationOperator.ISD,
										"test/ISD_1",
										"radiatedMethod",
										3,
										3,
		...
		ceISD_2.add(Pattern.compile("(.+\\.)?String stringVar\\_4 = atr2\\; //mutGenLimit 0"));
		ceISD_2.add(Pattern.compile("(.+\\.)?String stringVar\\_5 = atr2\\; //mutGenLimit 0"));
		Property propISD_2 = new Property(MutationOperator.ISD,
										"test/ISD_2",
										"radiatedMethod",
										4,
										4,
