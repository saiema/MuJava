...
public class PRVO_no_method_allowed_Options_Tests {
	...
	public static Collection<Object[]> firstValues() {
		...
		Property prop_ncll_addFirst_PRVOR = new Property(MutationOperator.PRVOR_REFINED, "pldi/nodecachinglinkedlist/NodeCachingLinkedList", "addFirst", 0, 0, ncll_me_addFirst_PRVOR, ncll_mne_addFirst_PRVOR);
		
		List<Pattern> ncll_me_addFirst_PRVOL = new LinkedList<Pattern>();
		List<Pattern> ncll_mne_addFirst_PRVOL = new LinkedList<Pattern>();
		Property prop_ncll_addFirst_PRVOL = new Property(MutationOperator.PRVOL_SMART, "pldi/nodecachinglinkedlist/NodeCachingLinkedList", "addFirst", 0, 0, ncll_me_addFirst_PRVOL, ncll_mne_addFirst_PRVOL);
		
		List<Pattern> ncll_me_addFirst_PRVOU = new LinkedList<Pattern>();
		List<Pattern> ncll_mne_addFirst_PRVOU = new LinkedList<Pattern>();
		Property prop_ncll_addFirst_PRVOU = new Property(MutationOperator.PRVOU_REFINED, "pldi/nodecachinglinkedlist/NodeCachingLinkedList", "addFirst", 0, 0, ncll_me_addFirst_PRVOU, ncll_mne_addFirst_PRVOU);
