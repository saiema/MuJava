...
public class PRVO_replaceAllByOne_right_Options_Tests {
	...
	public static Collection<Object[]> firstValues() {
		...
		//line 7 ---------------------------------------------------------
		Property prop_ncll_addFirst_PRVOR = new Property(Mutant.PRVOR_REFINED, "pldi/nodecachinglinkedlist/NodeCachingLinkedList", "addFirstUglyCopy", 15, 14, ncll_me_addFirst_PRVOR, ncll_mne_addFirst_PRVOR);
		
		
		List<Pattern> ncll_me_addFirst_PRVOL = new LinkedList<Pattern>();
		List<Pattern> ncll_mne_addFirst_PRVOL = new LinkedList<Pattern>();
		Property prop_ncll_addFirst_PRVOL = new Property(Mutant.PRVOL_SMART, "pldi/nodecachinglinkedlist/NodeCachingLinkedList", "addFirstUglyCopy", 0, 0, ncll_me_addFirst_PRVOL, ncll_mne_addFirst_PRVOL);
