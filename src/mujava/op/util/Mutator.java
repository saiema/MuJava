...
public class Mutator extends mujava.openjava.extension.VariableBinder
{
   ...
   //--------------
   public OJClass getType( Expression p ) throws ParseTreeException //modified (10/09/14) [simon] {protected -> public}
   {
      OJClass result = null;
      try 
      {
   ...
   public Map<OJClass, List<Variable>> getReachableVariables(ParseTreeObject exp) throws ParseTreeException {
	...
	public boolean compatibleAssignType(OJClass p, OJClass c){
		...
		if (p.getName().compareToIgnoreCase("java.lang.object") == 0 && c.isPrimitive()) {
			return true;
		}
	...
	public boolean compareNamesWithoutPackage(String name1, String name2) {
