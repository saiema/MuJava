...
public class ASRS extends MethodLevelMutator {
	 ...
	 * the other operators
	 */
	void genArithmeticMutants(AssignmentExpression p, int op) throws ParseTreeException {
	...
	private boolean isString(Expression p) throws ParseTreeException {
		OJClass type = getType(p);
		return OJSystem.STRING.compareTo(type) == 0;
	}
	...
	public void outputToFile(AssignmentExpression original, AssignmentExpression mutant) {
		...
		// ********** MUJAVA++ MODIFICATION **********//
		// ********** date: 7 Feb 2012 **********//
		MutantsInformationHolder.mainHolder().addMutation(MutationOperator.ASRS, original, mutant);
		return;
		// *******************************************//
